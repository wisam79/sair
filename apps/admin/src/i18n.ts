...
const resources = {
  ar: {
    translation: {
      ...
      profiles: {
        titles: { list: "المستخدمين", show: "عرض المستخدم", edit: "تعديل المستخدم", create: "إضافة مستخدم" },
        fields: {
      ...
      trips: {
        titles: { list: "الرحلات الحية", show: "عرض الرحلة", edit: "تعديل الرحلة", create: "إضافة رحلة" },
        fields: {
          status: "الحالة",
          route: "المسار",
          driver: "السائق",
      ...
      subscriptions: {
        titles: { list: "الاشتراكات", show: "عرض الاشتراك", edit: "تعديل الاشتراك", create: "إضافة اشتراك" },
        fields: {
          student: "الطالب",
          route: "الخط",
          status: "الحالة",
      ...
      license_batches: {
        titles: { list: "دفعات التراخيص", show: "عرض الدفعة", edit: "تعديل الدفعة", create: "إضافة دفعة" },
        fields: {
          name: "اسم الدفعة",
          route: "الخط",
          quantity: "الكمية",
      ...
      licenses: {
        titles: { list: "التراخيص", show: "عرض الترخيص", edit: "تعديل الترخيص", create: "إضافة ترخيص" },
        fields: {
          code: "الكود",
          status: "الحالة",
      ...
      drivers: {
        titles: { list: "إدارة السائقين", show: "عرض السائق", edit: "تعديل السائق", create: "إضافة سائق" }
      },
      actions: {
        actions: "الإجراءات",
        edit: "تعديل",
  ...
  en: {
    translation: {
      ...
      subscriptions: {
        titles: { list: "Subscriptions", show: "Show Subscription", edit: "Edit Subscription", create: "Create Subscription" },
        fields: {
          student: "Student",
          route: "Route",
          status: "Status",
      ...
      license_batches: {
        titles: { list: "License Batches", show: "Show Batch", edit: "Edit Batch", create: "Create Batch" },
        fields: {
          name: "Batch Name",
          route: "Route",
          quantity: "Quantity",
      ...
      licenses: {
        titles: { list: "Licenses", show: "Show License", edit: "Edit License", create: "Create License" },
        fields: {
          code: "Code",
          status: "Status",
          usedBy: "Used By",
      ...
      drivers: {
        titles: { list: "Drivers Management", show: "Show Driver", edit: "Edit Driver", create: "Create Driver" }
      },
      actions: {
        actions: "Actions",
      },
