  ...
  (e) => {
    ...
    let j = [
      ...
      I = {
        ...
        error: (0, x.jsx)(y, { fontSize: 'inherit' }),
      ...
      R = o.forwardRef(function (e, o) {
        let i = (0, s.useDefaultProps)({ props: e, name: 'MuiAlert' }),
          ...
          N = {
            slots: (0, l.default)({ closeButton: g.CloseButton, closeIcon: g.CloseIcon }, w),
        ...
        return (0, x.jsxs)(
          ...
          (0, l.default)(
            ...
            B,
            {
              children: [
                !1 !== C
                  ? (0, x.jsx)(z, { ownerState: P, className: W.icon, children: C || y[k] || I[k] })
                  : null,
                (0, x.jsx)(b, { ownerState: P, className: W.message, children: u }),
                null != n
                  ? (0, x.jsx)(L, { ownerState: P, className: W.action, children: n })
                  : null,
                null == n && S
                  ? (0, x.jsx)(L, {
                      ownerState: P,
