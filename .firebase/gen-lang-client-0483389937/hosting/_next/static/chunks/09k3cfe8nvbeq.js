(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = e.r(82094).createRenderSearchParamsFromClient;
    ('function' == typeof r.default || ('object' == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, '__esModule', { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
    ...
    let n = e.r(13592).createRenderParamsFromClient;
    ('function' == typeof r.default || ('object' == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, '__esModule', { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case 'validation-client':
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(95130);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(95130),
  ...
  (e, t, r) => {
          ...
          case 'request':
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(95130),
    ...
    function R(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(95130);
      return Promise.resolve(
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ('u' < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(67680);
        r = o(c);
        let { createParamsFromClient: i } = e.r(36835);
        return ((a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r }));
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(15407),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(18389),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ('u' < typeof window) {
        let { createParamsFromClient: a } = e.r(36835),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(18389),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
