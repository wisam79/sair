(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((i.ab =
      '/ROOT/Downloads/uniride/node_modules/.pnpm/next@16.2.6_@babel+core@7.2_94934eab48baafea29b44745a5acaf05/node_modules/next/dist/compiled/process/'),
      (t.exports = i(229)));
  },
  64775,
  (e, t, r) => {
  ...
  (e, t, r) => {
    ...
    ((j.constructor = O), v(j, x.prototype), (j.isPureReactComponent = !0));
    var E = Array.isArray;
    function T() {}
        ...
        !(function e(t, r, n, u, s) {
          ...
          if (E(t))
            ...
            for (t = h.call(t), h = 0; !(u = t.next()).done; )
              ((f = p + C((u = u.value), h++)), (d += e(u, r, n, f, s)));
          else if ('object' === f) {
    ...
    function U(e) {
      ...
      try {
        var n = e(),
          o = w.S;
        (null !== o && o(r, n),
          'object' == typeof n && null !== n && 'function' == typeof n.then && n.then(T, N));
      } catch (e) {
        N(e);
      } finally {
  ...
  (e, t, r) => {
    ...
    let n = 'u' < typeof window ? e.r(12764).workAsyncStorage : void 0;
    function o({ error: e }) {
      if (n) {
        let t = n.getStore();
  ...
  (e, t, r) => {
    ...
    function i() {
      return !(function () {
        if ('u' < typeof window) {
          let { workUnitAsyncStorage: t } = e.r(25871),
            r = t.getStore();
          if (!r) return !1;
          switch (r.type) {
            case 'prerender':
  ...
  (e, t, r) => {
    ...
    let i = e.r(14171),
      ...
      s = u[i.METADATA_BOUNDARY_NAME.slice(0)],
