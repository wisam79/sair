    ...
    return (
      ...
      >
        ...
        <View style={[styles.welcomeBottom, { paddingBottom: insets.bottom + 32 }]}>
          <TouchableOpacity style={styles.startBtn} onPress={goToRole} activeOpacity={0.85}>
        ...
        {authMode === "register" && role === "student" && (
          <View style={styles.field}>
            ...
            <TextInput
              ...
              placeholder="مثال: جامعة بغداد" placeholderTextColor={colors.mutedForeground} textAlign="right"
            />
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  logoArea: { alignItems: "center", flex: 1 },
  ...
  appNameEn: { fontSize: 16, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.5)", marginBottom: 20, letterSpacing: 2 },
  tagline: { fontSize: 16, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.75)", textAlign: "center", lineHeight: 26 },
  featuresGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12, justifyContent: "center", marginVertical: 32 },
  ...
  startBtn: { backgroundColor: "#FF6B35", flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 16, paddingHorizontal: 40, borderRadius: 30, gap: 10, width: "100%" },
  ...
  roleSubtitle: { fontSize: 15, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.65)", marginBottom: 32, textAlign: "right" },
  roleCards: { flex: 1, gap: 16 },
  roleCard: { borderRadius: 20, padding: 24, borderWidth: 1, borderColor: "rgba(255,255,255,0.15)" },
