...
function FeatherIcon({ name, size = 24, color = '#000', style }: Props) {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    phone: (
      <>
        <Path
          d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.56 1.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9a16 16 0 0 0 6.72 6.72l1.18-.83a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"
          {...common}
        />
      </>
    ),
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" style={style}>
      {content ?? <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth={2} fill="none" />}
    </Svg>
  );
}
