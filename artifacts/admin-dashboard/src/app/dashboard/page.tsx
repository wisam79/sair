...
export default async function DashboardPage() {
  ...
  const financialStats = [
    ...
    {
      title: 'صافي السائقين',
      value: formatCurrency(stats.totalRevenue - stats.totalCommission),
      icon: Calendar,
      color: 'bg-indigo-500',
    ...
    <div className="space-y-8" dir="rtl">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          ملخص إحصائيات النظام ليوم{' '}
          {new Intl.DateTimeFormat('ar-IQ', { timeZone: 'Asia/Baghdad' }).format(new Date())}
        </p>
      </div>
        ...
        {financialStats.map((stat, i) => (
          <div key={i} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center gap-3 mb-3">
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${stat.color} bg-opacity-10`}
              >
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {new Date(trip.createdAt).toLocaleTimeString('ar-IQ')}
                    </p>
                  </div>
                  <span
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            <a
              ...
              className="block p-4 rounded-lg bg-blue-50 hover:bg-blue-100"
            >
            ...
            <a
              ...
              className="block p-4 rounded-lg bg-green-50 hover:bg-green-100"
            >
            ...
            <a
              ...
              className="block p-4 rounded-lg bg-orange-50 hover:bg-orange-100"
            >
            ...
            <a
              ...
              className="block p-4 rounded-lg bg-purple-50 hover:bg-purple-100"
            >
