...
export const subscriptionRequestsTable = pgTable(
...
export const subscriptionsTable = pgTable(
  'subscriptions',
  {
    ...
    status: text('status', { enum: ['pending', 'active', 'cancelled', 'expired'] })
      .notNull()
      .default('pending'),
...
export const insertSubscriptionRequestSchema = createInsertSchema(subscriptionRequestsTable).omit({
  id: true,
  respondedAt: true,
  createdAt: true,
});
