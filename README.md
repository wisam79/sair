...
Sair is a robust, scalable, and highly secure platform designed to manage university student transportation in Iraq. Rebuilt from scratch (v2) to eliminate technical debt, introduce atomic transactions, and provide a seamless developer experience.

## 📚 Documentation Hub

Welcome to the Sair engineering documentation. Everything you need to understand, run, and scale this platform is documented below.
