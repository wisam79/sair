...
async function seed() {
  ...
  const seedProfiles: SeedProfile[] = [
    {
      fullName: 'أحمد محمد',
      phone: '0770000001',
      email: 'seed_student1@uniride.local',
      password: '123456',
      role: 'student',
      institutionId: instIds[0] || null,
      isActivated: true,
    },
    {
      fullName: 'سارة علي',
      phone: '0770000002',
      email: 'seed_student2@uniride.local',
      password: '123456',
      role: 'student',
      institutionId: instIds[0] || null,
      isActivated: true,
    },
    {
      fullName: 'خالد حسين',
      phone: '0770000003',
      email: 'seed_student3@uniride.local',
      password: '123456',
      role: 'student',
      institutionId: instIds[1] || null,
      isActivated: true,
    },
    {
      fullName: 'محمد كاظم',
      phone: '0770000004',
      email: 'seed_driver1@uniride.local',
      password: '123456',
      role: 'driver',
      institutionId: instIds[0] || null,
      isActivated: true,
    },
    {
      fullName: 'علي فاضل',
      phone: '0770000005',
      email: 'seed_driver2@uniride.local',
      password: '123456',
      role: 'driver',
      institutionId: instIds[1] || null,
      isActivated: true,
    },
    {
      ...
      phone: '0770000000',
      email: 'seed_admin@uniride.local',
      password: '123456',
      role: 'admin',
      institutionId: null,
      isActivated: true,
  ...
  for (let i = 0; i < Math.min(studentProfiles.length, driverProfiles.length); i++) {
    try {
      ...
      await db.execute(sql`
        ...
        VALUES (gen_random_uuid(), ${studentId}, ${driverId}, ${dp.fullName}, ${today.toISOString().split('T')[0]}, ${endDate.toISOString().split('T')[0]}, 90000, 1500, ${commissionAmount}, ${driverPayout}, 'paid', 0, 44, 'active', false, NOW(), NOW())
  ...
  console.log(
    `   - Profiles: ${seedProfiles.length} (${studentProfiles.length} students, ${driverProfiles.length} drivers, 1 admin)`,
  );
