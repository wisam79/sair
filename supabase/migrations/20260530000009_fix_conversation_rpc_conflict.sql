-- =================================================================
-- Migration: 20260530000009_fix_conversation_rpc_conflict.sql
-- Resolve column ambiguity in get_or_create_conversation using
-- #variable_conflict use_column compiler directive.
-- =================================================================

-- Drop and recreate function with conflict resolution directive
